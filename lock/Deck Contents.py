        ...
        if len(self.__Locks) > 0:
            ...
            while not self.__GameOver:
                ...
                while not self.__LockSolved and not self.__GameOver:
                    ...
                    print(f"You currently have {self.__Deck.GetNumberOfCards()} cards in the Deck.")
                    print(f"There are currently {self.__Deck.GetNumberOfToolCards()} ToolCards in the Deck")
...
class CardCollection():
    ...
    def GetNumberOfToolCards(self):
        ...
        for i in range(0,len(self._Cards)):
            if self._Cards[i].GetDescription() != "Dif":
                count += 1
        return count
