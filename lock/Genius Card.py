    ...
    def __GetCardFromDeck(self, CardChoice):
        if self.__Deck.GetNumberOfCards() > 0:
            ...
            if self.__Deck.GetCardDescriptionAt(0) == "Gen":
                ...
                print(self.__CurrentLock.GetLockDetails())
                choiceGen = input("Enter which lock you want to choose: ")
                self.__CurrentLock.GetChallengeMet(choiceGen -1, True)
